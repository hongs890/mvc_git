...
values(subj_seq.nextval,'computer','java,sql,cpp','park');


create or replace view subject_member as
select 
m.id,
m.pw,
m.name,
...
select id as id major as major subjects as sub from subject where id = 'park';